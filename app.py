...
🤖 Я бот-магазин 20moda21.ua! Здесь вы увидите в продаже Одежду!.
    
🛍️ Чтобы перейти в каталог и выбрать приглянувшиеся товары возпользуйтесь командой /menu.

💰 Пополнить счет можно через PrivatBank, MonoBank или PayPal.

❓ Возникли вопросы? Не проблема! Команда /sos поможет связаться с админами, которые постараются как можно быстрее откликнуться.

🤝 Заказать похожего бота? Свяжитесь с разработчиком <a href="https://t.me/l_criminologist_l">Денис</a>, он не кусается)))
    ''', reply_markup=markup)
